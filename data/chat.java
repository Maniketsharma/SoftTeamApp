...
public class chat extends AppCompatActivity {
    ...
    private final List<chatUser> chatLists = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) final TextView nameTV = findViewById(R.id.r_name);
        final EditText messageEditText = findViewById(R.id.messageEditText);
        final ImageView sendBtn = findViewById(R.id.sentbtn);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://softteam-88b9b-default-rtdb.firebaseio.com");
                ...
                for (DataSnapshot chatMessages : snapshot.child("chat").child(chatKey).getChildren()) {
                    ...
                    if (chatMessages.hasChild("msg") && chatMessages.hasChild("mobile")) {
                        ...
                        if (loadingFirstTime || getMessageTimeStamps > lastSavedTimestamps) {
                            ...
                            // chat list
                            final chatUser chatList = new chatUser(getMobile, getMsg, messageDate, messageTime);
