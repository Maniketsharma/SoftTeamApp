...
import java.util.List;
    ...
    public class MainActivity extends AppCompatActivity {
        ...
        private final List<MessageList> userMessagesList = new ArrayList<>();
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            messagesAdapter = new MessageAdapter(userMessagesList, MainActivity.this);
        ...
        private void loadData(String chatKey, String fullName, String mobile, String lastMessage, int unseenMessagesCount) {
            if (!mobileAlreadyExists(mobile)) {
                MessageList messagesList = new MessageList(chatKey, fullName, mobile, lastMessage, unseenMessagesCount);
        ...
        private boolean mobileAlreadyExists(String mobile) {
            for (MessageList message : userMessagesList) {
